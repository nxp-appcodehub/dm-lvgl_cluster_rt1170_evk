...
/* Define color for shell */
#define DEFINE_SHELL_PROMPT(prompt)       HL_GREEN prompt NOCOLOR
#define FORMAT_CMD_COLOR(command)         "\""HL_BLUE command NOCOLOR"\":"
