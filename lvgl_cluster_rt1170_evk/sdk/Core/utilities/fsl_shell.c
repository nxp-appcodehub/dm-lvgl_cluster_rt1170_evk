...
#define SHELL_WriteWithCopy SHELL_Write
...
static SHELL_COMMAND_DEFINE(help, FORMAT_CMD_COLOR("help")"                 List all the registered commands\r\n", SHELL_HelpCommand, 0);
static SHELL_COMMAND_DEFINE(exit, FORMAT_CMD_COLOR("exit")"                 Exit program\r\n", SHELL_ExitCommand, 0);
...
#define SHELL_WRITE(x)  SHELL_Write(shellContextHandle, (char *)x, strlen(x)) 
#define GRM_COLOR HL_PURPLE

    
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "               11111111111               \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "            111    10    1111            \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "          11       10        11          \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "        11          1     1   11         \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "        1                10     1        \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "    11111               01      11111    \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "  11     11        11 101     11  1  11  \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, " 0        11     11   11     11        0 \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "11   101   0    0      11    0    0    11\r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "11    0    0    0       1    0   111   11\r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, " 0        11    11     0     11       10 \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "  11 11 111       11111       111 1  11  \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "    1111                        11111    \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "        1                       1        \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "         11                   11         \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "          111      10       111          \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "            11111  10   11111            \r\n"));
    SHELL_WRITE(SET_COLOR_STR(GRM_COLOR, "               1111111111                \r\n"));

    SHELL_Write(shellContextHandle, "\r\n"HL_PURPLE"SHELL build: ", strlen("\r\n"HL_PURPLE"SHELL build: "));
...
static void SHELL_WriteWithCopy1(shell_handle_t shellHandle, const char *buffer, uint32_t length)
{
